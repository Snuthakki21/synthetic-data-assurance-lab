...
[![Tests and coverage](https://github.com/Snuthakki21/synthetic-data-assurance-lab/actions/workflows/ci.yml/badge.svg)](https://github.com/Snuthakki21/synthetic-data-assurance-lab/actions/workflows/ci.yml) [![Publish application](https://github.com/Snuthakki21/synthetic-data-assurance-lab/actions/workflows/pages.yml/badge.svg)](https://github.com/Snuthakki21/synthetic-data-assurance-lab/actions/workflows/pages.yml)

**[Open the application](https://Snuthakki21.github.io/synthetic-data-assurance-lab/)** · [Independent Staff Engineer review](projects/synthetic_data_foundry/independent-staff-review.md) · [Shared runtime review](docs/INDEPENDENT_RUNTIME_REVIEW.md) · [Verification evidence](docs/VALIDATION.md) · [Tests](tests) · [Run locally](docs/RUNNING.md)

![Application workspace](docs/screenshots/desktop.png)

Examples: [Default input](examples/base.json) · [Broken relationship and precision](examples/scenario-2.json) · [Executed default report](examples/report.json)
...
The report includes `details.records`, independently computed constraint failures, rule version, seed, per-enum distributions and separate timing measurements. Change `row_counts`, bounds, weights, nullable rates or seed and rerun. Original inputs are in [fixtures](projects/synthetic_data_foundry/fixtures). The rule-request field can ask the optional provider for a structured narrower numeric-range proposal. Valid proposals remain **unapplied until reviewed**; edit and version the rules to adopt one.
...
See [engineering review](projects/synthetic_data_foundry/docs/engineering-review.md) for traceable acceptance checks, plugin contributions and review limits.

Measured local module coverage, with source and test hashes: [coverage-summary.json](projects/synthetic_data_foundry/docs/coverage-summary.json). Coverage is execution evidence, not proof of correctness; provider integration and independent automated review are separate checks.
